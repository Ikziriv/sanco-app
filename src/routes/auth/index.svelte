...
>
	<!-- Component Start -->
	<div class="w-full max-w-sm p-6 m-auto bg-white rounded-md shadow-lg dark:bg-gray-800">
			...
			<div class="mt-4">
				<div class="flex items-center justify-between">
					<label for="password" class="block text-sm text-gray-800 dark:text-gray-200"
						>Password</label
					>
					<a href="/auth/reset" class="text-xs text-gray-600 dark:text-gray-400 hover:underline"
						>Forget Password?</a
					>
				</div>
		...
		<div class="flex items-center mt-6 -mx-2">
			...
			>
				<span class="hidden mx-2 sm:inline">Magic Link</span>
			</a>
		...
		<p class="mt-8 text-xs font-light text-center text-gray-400">
			Don't have an account? <a
				href="/auth/register"
				class="font-medium text-gray-800 dark:text-gray-200 hover:underline">Create One</a
			>
		</p>
	</div>
	<!-- Component End  -->
