...
<div class="w-full">
	<button class="px-4 py-4 w-full" on:click={() => (isOpen = !isOpen)}>
		<div
			class="flex w-full mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 border-l-4 border-amber-500"
		>
			...
			<div class="w-2/3 p-4 md:p-4">
				<div class="flex justify-end mt-3 item-center">
					...
					>
					<button
						class="px-2 text-center py-1 text-xs font-bold text-gray-900 uppercase transition-colors duration-200 transform rounded"
					>
